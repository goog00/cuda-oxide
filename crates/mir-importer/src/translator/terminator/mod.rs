...
fn try_dispatch_intrinsic(
    ...
    match name {
        ...
        "cuda_device::warp::redux_sync_fmin" => Ok(Some(intrinsics::warp::emit_warp_redux_f32(
            ctx,
            body,
            dialect_nvvm::ops::ReduxSyncFminOp::get_concrete_op_info(),
            args,
            destination,
            target,
            block_ptr,
        ...
        "cuda_device::warp::redux_sync_fmax" => Ok(Some(intrinsics::warp::emit_warp_redux_f32(
            ctx,
            body,
            dialect_nvvm::ops::ReduxSyncFmaxOp::get_concrete_op_info(),
            args,
            destination,
            target,
            block_ptr,
